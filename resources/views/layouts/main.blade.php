...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container mx-auto flex items-center justify-between px-1 py-6">

            <ul class="flex flex-row items-center">
                {{-- Nav --}}
                <div x-data="{ navOpen: false }">
                    <li class="mt-1 mr-2">
                        <button class="md:hidden" @click="navOpen = true">
                            <svg class="w-6" fill="white" viewBox="0 0 24 24">
                    ...
                    <template x-if="navOpen">
                        <div style="background-color: rgba(0, 0, 0, .5);"
                            ...
                            <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto w-[20rem]">
                                <div class="bg-gray-900 rounded pb-8 mb-[rem]">
                                    <div class="flex justify-end pr-4 pt-2">
                                        <button @click="navOpen = false" @keydown.escape.window="navOpen = false"
                                        ...
                                        <div class="relative flex flex-col items-center">
                                            <li class="mb-4">
                                                <a href="{{ route('movies.index') }}"
                                                    class="hover:text-gray-300 mt-3 md:mt-0">Movies</a>
                                            </li>
                                            <li class="my-4">
                                                <a href="{{ route('tv.index') }}"
                                                    class="hover:text-gray-300 mt-3 md:mt-0">TV Shows</a>
                                            </li>
                                            <li class="mt-4">
                                                <a href="{{ route('actors.index') }}"
                                                    class="hover:text-gray-300 mt-3 md:mt-0">Actors</a>
                                            </li>
                                        </div>
                                    </div>
                                </div>
                ...
                <li>
                    <a href="{{ route('movies.index') }}">
                        <svg class="w-28 sm:w-32" viewBox="0 0 96 24" fill="none">
                            <path
                ...
                <li class="hidden md:inline-block md:ml-16">
                    <a href="{{ route('movies.index') }}" class="hover:text-gray-300 mt-3 md:mt-0">Movies</a>
                </li>
                <li class="hidden md:inline-block md:ml-6">
            ...
            <div class="flex items-center">
                <livewire:search-dropdown>
                    ...
                    <div class="ml-4">
                        <a href="#">
                            <img src="/img/avatar.jpg" alt="avatar" class="rounded-full w-6 h-6 sm:w-8 sm:h-8">
                        </a>
                    </div>
            </div>
